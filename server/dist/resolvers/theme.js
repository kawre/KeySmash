...
let ThemeResolver = class ThemeResolver {
    ...
    changeTheme(theme, { req }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!userId)
                return null;
            yield User_1.User.update(userId, { theme });
            return Theme_1.Theme.findOne({ name: theme });
        });
    }
};
__decorate([
    type_graphql_1.Query(() => [Theme_1.Theme]),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ThemeResolver.prototype, "themes", null);
__decorate([
    type_graphql_1.Mutation(() => Theme_1.Theme, { nullable: true }),
    __param(0, type_graphql_1.Arg("name")),
    __param(1, type_graphql_1.Ctx()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ThemeResolver.prototype, "changeTheme", null);
ThemeResolver = __decorate([
    type_graphql_1.Resolver(Theme_1.Theme)
], ThemeResolver);
